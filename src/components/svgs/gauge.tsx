...
const speedToRotate = (speed: number) => (speed > 180 ? 180 : speed);
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height="23" width="23">
      ...
      >
        ...
        <path
          d="M12 12H12"
          transform={`rotate(${speedToRotate(props.speed)} 12 12)`}
        >
          <animate
            fill="freeze"
            attributeName="d"
      ...
      <g fill="currentColor">
        ...
        >
          <set attributeName="fill-opacity" begin="0.5s" to="1" />
          <animate
            fill="freeze"
            attributeName="d"
            begin="0.5s"
